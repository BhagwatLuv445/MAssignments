...
public class EmployeeDetails {
	...
	if(sd.equalsIgnoreCase("search")){
		...
		case 1: System.out.println("Enter name to delete");
		        String name;
		        name=kb.next();
		        EmployeeDetailsManipulation.deleteByName(str, name);
				break;
		case 2: System.out.println("Enter dept to delete");
		        String dept=kb.next();
		        EmployeeDetailsManipulation.deleteByDept(str, dept);
				break;
		case 3: System.out.println("Enter phone to delete");
		        String phone=kb.next();
		        EmployeeDetailsManipulation.deleteByPhone(str, phone);
				break;
		case 4: System.out.println("Enter address to delete");
		        String add=kb.next();
		        EmployeeDetailsManipulation.deleteByAddress(str, add);
				break;
		default :System.out.println("Enter correct");
		}
	}else{
