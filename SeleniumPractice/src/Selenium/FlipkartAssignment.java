...
public class FlipkartAssignment {
	...
	public static void call(WebDriver driver) throws InterruptedException {
			...
			//Thread.sleep(5000);
			new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='container']//div[4]/a"))).click();
